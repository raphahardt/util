...
class SQLIUpdate extends SQLInstructionBase implements SQLArrayAccess {
  ...
  public function __construct(SQLTable $table, $fields = array(), $where = null, $defs = null) { 
    parent::__construct();
    $this->build($table, $fields, $where, $defs);
  }
  
  public function build(SQLTable $table, $fields = array(), $where = null, $defs = null) { 
